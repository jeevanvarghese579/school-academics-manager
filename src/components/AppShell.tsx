  ...
  const SidebarContent = () => (
    <>
      <div className="px-4 py-5 flex items-center gap-3">
        <Logo size={40} />
        <div>
          <h1 className="text-base font-bold text-gray-900 dark:text-white leading-tight">SAM</h1>
          <p className="text-[10px] text-gray-500 dark:text-gray-400 -mt-0.5">Academics Manager</p>
        </div>
      </div>
      ...
      <div className="px-3 mb-2">
        ...
        >
          ...
          {isOnline ? 'Online Mode — Cloud Sync' : 'Offline Mode — This Device Only'}
        </div>
      </div>
    ...
    <div className="min-h-screen flex bg-gray-50 dark:bg-gray-950">
      ...
      <div className="flex-1 md:ml-64 flex flex-col min-h-screen">
        ...
        <header className="md:hidden sticky top-0 z-20 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-4 py-3 flex items-center justify-between no-print">
          <button onClick={() => setMobileOpen(true)} className="btn-icon" aria-label="Open menu">
